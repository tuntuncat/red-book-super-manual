...
上下文在JS中被实例化为一个栈（执行上下文栈）：当进入创建阶段时，新的上下文入栈。当执行完毕，当前上下文出栈，回到原来的上下文中。
...
学习作用域要联系第3章的变量声明说明：[#3.1.1-bian-liang-sheng-ming-3](di-3-zhang-yu-yan-ji-chu.md#3.1.1-bian-liang-sheng-ming-3 "mention"), 主要是熟悉TDZ，声明提前等特性。
